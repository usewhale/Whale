...
func isCriticalEvent(kind EventKind) bool {
	switch kind {
	case EventError, EventPlanCompleted, EventPlanUpdate, EventProviderRetry, EventResponseReset, EventToolCall, EventToolResult, EventHookStarted, EventHookCompleted, EventTaskStarted, EventTaskCompleted, EventMCPComplete, EventApprovalRequired, EventApprovalDecision, EventUserInputRequired, EventUserInputDone, EventSessionsListed, EventLocalSubmitResult, EventLocalSubmitDone, EventDiffResult, EventBtwStarted, EventBtwDelta, EventBtwDone, EventBtwError, EventPendingInputAccepted, EventPendingInputRejected, EventTurnDone, EventModelSelectionRequested, EventPermissionsSelectionRequested, EventSkillsSelectionRequested, EventSkillsManagerUpdated, EventPluginsManagerUpdated, EventConfigManagerUpdated, EventHooksManagerUpdated, EventHooksStartupReviewRequested, EventReviewRequested, EventSkillLoaded, EventWorktreeExitPrompt, EventExitRequested, EventScreenClearRequested, EventSessionHydrated, EventWorkflowPanel, EventWorkflowSnapshot, EventWorkflowResult, EventWorkflowTerminal:
		return true
	default:
		return false
	}
